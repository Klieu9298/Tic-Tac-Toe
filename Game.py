...
def modeOne():
    ...
    def Owinner():
        ...
        global yScore
        oScore += 1
        osc = Text(Point(493, 75), xScore)
        osc.setTextColor('black')
        osc.setStyle('bold')
        osc.setSize(17)
        osc.draw(win)
        gameTwo()
...
def modeThree():
    ...
    import random
    option0 = ("Colors you want to choose")
    option1 = ("Colors you want to choose")
    option2 = ("Colors you want to choose")
    option3 = ("Colors you want to choose")
    option4 = ("Colors you want to choose")

    r = random.choice([option0, option1, option2, option3, option4])
        ...
        def winnerCheck():
            if (win.items[0].getText() == win.items[1].getText() and win.items[1].getText() == win.items[2].getText()):
                if win.items[0].getText() == 'X':
                    ...
                    Owinner()
                return False
            elif (win.items[3].getText() == win.items[4].getText() and win.items[4].getText() == win.items[
                5].getText()):
                if win.items[3].getText() == 'X':
                    Xwinner()
                elif win.items[3].getText() == 'O':
                    Owinner()
                return False
            elif (win.items[6].getText() == win.items[7].getText() and win.items[7].getText() == win.items[
                8].getText()):
                if win.items[6].getText() == 'X':
                    Xwinner()
                elif win.items[6].getText() == 'O':
                    Owinner()
                return False
            elif (win.items[0].getText() == win.items[3].getText() and win.items[3].getText() == win.items[
                6].getText()):
                if win.items[0].getText() == 'X':
                    Xwinner()
                elif win.items[0].getText() == 'O':
                    Owinner()
                return False
            elif (win.items[1].getText() == win.items[4].getText() and win.items[4].getText() == win.items[
                7].getText()):
                if win.items[1].getText() == 'X':
                    Xwinner()
                elif win.items[1].getText() == 'O':
                    Owinner()
                return False
            elif (win.items[2].getText() == win.items[5].getText() and win.items[5].getText() == win.items[
                8].getText()):
                if win.items[2].getText() == 'X':
                    Xwinner()
                elif win.items[2].getText() == 'O':
                    Owinner()
                return False
            elif (win.items[0].getText() == win.items[4].getText() and win.items[4].getText() == win.items[
                8].getText()):
                if win.items[0].getText() == 'X':
                    Xwinner()
                elif win.items[0].getText() == 'O':
                    Owinner()
                return False
            elif (win.items[2].getText() == win.items[4].getText() and win.items[4].getText() == win.items[
                6].getText()):
                if win.items[2].getText() == 'X':
                    Xwinner()
                elif win.items[2].getText() == 'O':
